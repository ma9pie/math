...
describe('math test', () => {
  ...
  // Format
  test('', () => {
    const result = math(1e18).format(18).value();
    expect(result).toEqual('1');
  });
  test('', () => {
    const result = math('1e18').format(18).value();
  ...
  test('', () => {
    const result = math(1).format(18).value();
    expect(result).toEqual('0.000000000000000001');
  });
  test('', () => {
    const result = math('-123').format(18).value();
    expect(result).toEqual('-0.000000000000000123');
  });
  test('', () => {
    const result = math(0).format(18).value();
    expect(result).toEqual('0');
  });
  test('', () => {
    const result = math(BigInt(1)).format(3).value();
    expect(result).toEqual('0.001');
  });

  // Parse
  test('', () => {
    const result = math(1).parse(18).value();
    expect(result).toEqual('1000000000000000000');
  });
  test('', () => {
    const result = math('0.000000000000000001').parse(18).value();
    expect(result).toEqual('1');
  });
  test('', () => {
    const result = math('-0.000000000000000123').parse(18).value();
    expect(result).toEqual('-123');
  });
  test('', () => {
    const result = math(0).parse(18).value();
    expect(result).toEqual('0');
  });
  test('', () => {
    const result = math(BigInt(3)).parse(18).value();
    expect(result).toEqual('3000000000000000000');
  });
  test('', () => {
    const result = math(BigInt(0)).parse(18).value();
    expect(result).toEqual('0');
  });
  test('', () => {
    const result = math(BigInt(1)).parse(3).value();
